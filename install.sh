...
install_V2bX() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -q -N --no-check-certificate -O /usr/local/V2bX/V2bX-linux.zip https://github.com/limo13660/V2bX/releases/download/${last_version}/V2bX-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/limo13660/V2bX/releases/download/${last_version}/V2bX-linux-${arch}.zip"
        echo -e "开始安装 V2bX $1"
    ...
    file="https://github.com/limo13660/V2bX-script/raw/master/V2bX.service"
    ...
    curl -o /usr/bin/V2bX -Ls https://raw.githubusercontent.com/limo13660/V2bX-script/master/V2bX.sh
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://raw.githubusercontent.com/limo13660/V2bX-script/master/initconfig.sh
